  ...
  species&tree = 5  Pmun Dint Dgol Dcel Dlud
                    1 1 1 1 1
                (Pmun, (Dint,((j[&phi=0.200000,tau-parent=yes],(l[&phi=0.200000,tau-parent=no],Dlud)k)i,((Dcel)j[&phi=0.800000,tau-parent=yes],(Dgol)l[&phi=0.800000,tau-parent=yes])u)t)s)r;
      phase = 0 0 0 0 0
