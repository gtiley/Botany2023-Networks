...
We meet on 23 July at 8:00 and the room is TBD. Participants must bring their own laptop. Some basic software and libraries should be installed in advance to use the time effectively, with instructions posted [here]({{site.baseurl}}/pre-workshop).
...
The schedule may experience minor changes prior to the workshop start. Material and links will be updated before the workshop.
